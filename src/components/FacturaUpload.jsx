...
=======
  const chamarContinuar = async (ceResult) => {
    try {
      const payload = {
        cliente: { nombre: cliente.nombre, apellidos: cliente.apellidos, correo: cliente.correo, telefono: cliente.telefono, direccion: cliente.direccion, lat: userCoords?.lat ?? null, lon: userCoords?.lon ?? null },
