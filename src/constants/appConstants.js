...
export const MAINTENANCE_MODE = false; // true = muestra la pantalla "En mantenimiento" al abrir y bloquea toda la app
...
export const API_BASE           = (import.meta.env.VITE_API_URL || "https://extractor.51.44.13.132.nip.io").replace(/\/$/, "");
