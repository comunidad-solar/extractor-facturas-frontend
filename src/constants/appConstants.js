...
export const CE_FOTO_ENABLED = false; // true = busca foto da CE via GET /ce/foto; false = usa /Intersect.png // true = muestra mock si no hay datos del cotizador; false = oculta el componente
